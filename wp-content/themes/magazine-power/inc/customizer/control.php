 ...
 */
class Magazine_Power_Heading_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Magazine_Power_Message_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Magazine_Power_Radio_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'magazine-power-customize-controls' );
		wp_enqueue_style( 'magazine-power-customize-controls' );
	}
 ...
 * @see WP_Customize_Control
 */
class Magazine_Power_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'magazine-power' );
 ...
 * @see WP_Customize_Control
 */
class Magazine_Power_Dropdown_Sidebars_Control extends WP_Customize_Control {
 ...
 * @since 1.0.0
 */
class Magazine_Power_Customize_Section_Upsell extends WP_Customize_Section {
