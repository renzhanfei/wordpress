 ...
 * @return array Files.
 */
function magazine_power_ocdi_files() {

	return array(
		array(
			'import_file_name'             => esc_html__( 'Theme Demo Content', 'magazine-power' ),
			'local_import_file'            => trailingslashit( get_template_directory() ) . 'ocdi/magazine-power.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'ocdi/magazine-power.wie',
			'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'ocdi/magazine-power.dat',
			),
		);
}

add_filter( 'pt-ocdi/import_files', 'magazine_power_ocdi_files', 99 );
 ...
 * @since 1.0.0
 */
function magazine_power_ocdi_after_import() {
...
add_action( 'pt-ocdi/after_import', 'magazine_power_ocdi_after_import' );
